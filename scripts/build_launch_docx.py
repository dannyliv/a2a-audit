...
doc.add_heading("Findings at a glance (114 live cards)", 1)
para("Mean score: 76.4 out of 100, a C.")
para("Grade distribution: 13 A, 7 B, 81 C, 6 D, 7 F (114 total).")
para("Unsigned cards: 114 of 114 (100 percent).")
para("No authentication declared: 88 of 114 (77 percent).")
para("No provider information: 15 of 114 (13 percent).")
para("Push notifications enabled with no declared auth: 5 of 114 (4 percent). Push notifications flagged for webhook URL validation: 4 of 114 (4 percent). Combined push-notification findings: 9 of 114 (8 percent).")
para("Protocol version split: v0.3 on 84 cards (74 percent), v1.0 on 23 (20 percent), v0.2 on 6 (5 percent), 1 unknown.")
para("Responsible disclosure: figures are aggregate only, no agent named. Source a2aregistry.org and public A2A directories, captured 2026-05-29.", italic=True)
...
para("C. Valid is not the same as safe. 114 live AI agents passed as working software. On security posture, the mean score was 76.4 (a C) and 100 percent were unsigned.")
...
para("Across the 114 cards, all 114 (100 percent) were unsigned. 88 of them (77 percent) required no authentication at all. The mean score was 76.4, a C. The grade distribution: 13 A's, 7 B's, 81 C's, 6 D's, and 7 F's. The few that earned an A were unsigned too. They had less else wrong.")
...
para("C. Valid is not the same as safe. 114 live AI agents worked fine as software. On security posture, the mean score was 76.4 (a C).")
...
para("All 114 (100 percent) were unsigned. 88 of 114 (77 percent) required no authentication. The mean security score was 76.4, a C, with 13 A's, 7 B's, 81 C's, 6 D's, and 7 F's.")
...
para("C. Valid is not safe. 114 live AI agents worked fine. Mean security score: 76.4, a C.")
...
para("2/ All 114 (100 percent) were unsigned. 88 of 114 (77 percent) required no authentication. Mean score 76.4, a C: 13 A's, 7 B's, 81 C's, 6 D's, 7 F's. The few A's were unsigned too. They had less else wrong.")
